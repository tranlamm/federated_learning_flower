...
# Variable
agent = DDPGagent(state_dims=state_dims, action_dims=action_dims)
train_time = []
val_loss = []
val_acc = []
reward = []
...
class CustomStrategy(fl.server.strategy.FedAvg):
    ...
    def aggregate_fit(
        ...
        if self.pre_state is not None:
            agent.memory.push(self.pre_state, self.pre_action, curr_reward, curr_state)
        ...
        nextTrainTime = self.train_time + action
